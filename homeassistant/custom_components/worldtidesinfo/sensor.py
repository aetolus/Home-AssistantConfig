...
class WorldTidesInfoSensor(Entity):
    ...
    def device_state_attributes(self):
        ...
        if "High" in str(self.data['extremes'][0]['type']):
            hightidetime = time.strftime('%I:%M %p', time.localtime(self.data['extremes'][0]['dt']))
            lowtidetime = time.strftime('%I:%M %p', time.localtime(self.data['extremes'][1]['dt']))
            attr['high_tide_time'] = hightidetime
            attr['low_tide_time'] = lowtidetime
            ...
            hightidetime = time.strftime('%I:%M %p', time.localtime(self.data['extremes'][1]['dt']))
            lowtidetime = time.strftime('%I:%M %p', time.localtime(self.data['extremes'][0]['dt']))
            attr['high_tide_time'] = hightidetime
            attr['low_tide_time'] = lowtidetime
