...
def setup_platform(hass, config, add_devices, discovery_info=None):
    ...
    data = Life360SensorData(username, password, COMMAND1,
                             COMMAND2, COMMAND3, mqtt_topic, hass)
...
class Life360SensorData(object):
    ...
    def update(self):
        ...
        try:
            ...
            self.COMMAND_ACCESS_TOKEN = self.COMMAND_ACCESS_TOKEN.replace(
                "USERNAME360", self.username)
            self.COMMAND_ACCESS_TOKEN = self.COMMAND_ACCESS_TOKEN.replace(
                "PASSWORD360", self.password)
            ...
            self.COMMAND_ID = self.COMMAND_ID.replace(
            ...
            self.COMMAND_MEMBERS = self.COMMAND_MEMBERS.replace(
                "ACCESS_TOKEN", access_token)
