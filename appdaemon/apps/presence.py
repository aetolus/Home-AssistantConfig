...
class Presence(hass.Hass):
    ...
    def check_lastupdated(self, kwargs):
        ...
        if kyle_lastupdated > 3600 and 'device_tracker.kyle_phone' in self.get_state(entity="group.kyle", attribute='entity_id'):
        ...
        elif kyle_lastupdated < 3600 and 'device_tracker.kyle_phone' not in self.get_state(entity="group.kyle", attribute='entity_id'):
        ...
        if sarah_lastupdated > 3600 and 'device_tracker.sarah_phone' in self.get_state(entity="group.sarah", attribute='entity_id'):
        ...
        elif sarah_lastupdated < 3600 and 'device_tracker.sarah_phone' not in self.get_state(entity="group.sarah", attribute='entity_id'):
